...
('return_date', CURRENT_TIMESTAMP + INTERVAL '180 days', 'Ngày Trở Về', 'Đếm ngược đến ngày Peanut xuất ngũ', TRUE)
ON CONFLICT DO NOTHING;

-- ============================================
-- 11. SITE SETTINGS TABLE (Customizable texts)
-- ============================================
...
('login_welcome_title', 'Welcome!', 'Login page welcome title'),
('login_welcome_message', 'Log in to join the Peanut fan community', 'Login page welcome message'),
...
('about_content', 'Welcome to Wangho''s Flower Garden - A special place for Peanut''s fans to connect and celebrate together.', 'About page content'),
('about_popup_enabled', 'false', 'Show about popup on homepage')
ON CONFLICT (setting_key) DO NOTHING;

-- ============================================
-- 12. EVENTS TABLE (Admin posts/news)
-- ============================================
...
-- ============================================
-- 13. FEEDBACK TABLE (User suggestions/feedback)
-- ============================================
