STT	Function	Prioty
1	Chức năng chuyển đổi ngôn ngữ	Medium 
	Chuyển đổi ngôn ngữ sang các thứ tiếng: Anh, Trung, Hàn, Việt (Có thể thay đổi thông tin hiển thị theo từng ngôn ngữ)	Medium 
2	Đăng ký và đăng nhập tài khoản thành viên:	Urgent 
	Chức năng đăng ký tài khoản người dùng (email không phân biệt đuôi email, mật khẩu, tên người dùng).	Urgent 
...
4	Cây điểm danh (tưới nước hàng ngày):	Low 
	Một hình ảnh cây sẽ phát triển theo thời gian người dùng tưới nước hàng ngày.	Low 
	Người dùng có thể nhấp vào cây để tưới nước và đánh dấu là đã điểm danh.	Low 
	Lưu trạng thái tưới nước mỗi ngày, kiểm tra và thông báo nếu người dùng quên điểm danh.	Low 
...
6	Mục nhập lời chúc sinh nhật:	Urgent 
	...
	Lời chúc sẽ được gửi đến quản trị viên để kiểm duyệt và tổng hợp.	Urgent 
	Lời chúc sẽ được thể hiện dưới hình thức đặc biệt khác (Khoảng 302 lời chúc)	Urgent 
7	Mục nhập lời chúc debut:	Urgent 
	Người dùng có thể nhập lời chúc cá nhân về hành trình sự nghiệp của Peanut	Urgent 
	Lời chúc sẽ được gửi đến quản trị viên để kiểm duyệt và tổng hợp.	Urgent 
	Lời chúc sẽ được thể hiện dưới hình thức đặc biệt khác (Sẽ cập nhật chi tiết sau)	Urgent 
8	Mục cập nhật nhật ký:	Optional 
	Người dùng có thể viết nhật ký hàng ngày.	Optional 
	Cho phép người dùng tag các tài khoản khác trong nhật ký.	Optional 
	Status có thể được công khai hoặc chỉ giới hạn bạn bè.	Optional 
9	Tính năng kết bạn:	Optional 
...
12	Trang cá nhân của người dùng	Urgent 
	Người dùng có thể xem lại các hoạt động của mình trên web	Urgent 
	Người dùng sẽ nhận được các huy hiệu (11 huy hiệu) khi đạt được những cột mốc như 302 ngày điểm danh, gửi 11 lời chúc, ...	Urgent 